...
try:
    ...
    sys.exit("Please provide the transaction ID as a command line argument "
             "(e.g. python prime_get_transaction.py <transaction_id>).")


uri = f'https://api.prime.coinbase.com/v1/portfolios/{PORTFOLIO_ID}/transactions/{transaction_id}'
