...
try:
    ...
    print("Please provide base and quote currency separated by a space as command line arguments (e.g. ETH USD).")
    sys.exit(1)

uri = f'https://api.prime.coinbase.com/v1/portfolios/{PORTFOLIO_ID}/' \
      f'buying_power?base_currency={base_currency}&quote_currency={quote_currency}'
