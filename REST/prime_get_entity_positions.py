...
parser.add_argument('--product-id', type=str, help='Product ID to filter positions')
...
query_params = []
if args.product_id:
    query_params.append(f'product_id={args.product_id}')

query_string = '&'.join(query_params)
uri = f'https://api.prime.coinbase.com/v1/entities/{ENTITY_ID}/futures/positions'
if query_string:
    uri += f'?{query_string}'
