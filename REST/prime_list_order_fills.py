...
parser.add_argument('--order-id', type=str, required=True, help='Order ID')

args = parser.parse_args()

uri = f'https://api.prime.coinbase.com/v1/portfolios/{PORTFOLIO_ID}/orders/{args.order_id}/fills'
