...
parser.add_argument('--base', type=str, required=True, help='Base currency (e.g., BTC, ETH)')
parser.add_argument('--quote', type=str, required=True, help='Quote currency (e.g., USD)')

args = parser.parse_args()

uri = f'https://api.prime.coinbase.com/v1/portfolios/{PORTFOLIO_ID}/buying_power?base_currency={args.base}&quote_currency={args.quote}'
