...
parser = argparse.ArgumentParser(description='List transaction validators')
parser.add_argument('--transaction-ids', type=str, required=True, help='Comma-separated list of transaction IDs')

args = parser.parse_args()

uri = f'https://api.prime.coinbase.com/v1/portfolios/{PORTFOLIO_ID}/staking/transaction-validators/query'
