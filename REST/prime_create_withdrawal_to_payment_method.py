...
USD_TRADING_BALANCE_ID = os.environ.get('USD_TRADING_BALANCE_ID')
PAYMENT_METHOD_ID = os.environ.get('PAYMENT_METHOD_ID')

amount = '1'
currency_symbol = 'USD'
destination_type = 'DESTINATION_PAYMENT_METHOD'

uri = f'https://api.prime.coinbase.com/v1/portfolios/{PORTFOLIO_ID}/wallets/{USD_TRADING_BALANCE_ID}/withdrawals'
timestamp = str(int(time.time()))
idempotency_key = str(uuid.uuid4())

payload = {
    'portfolio_id': PORTFOLIO_ID,
    'wallet_id': USD_TRADING_BALANCE_ID,
    'amount': amount,
